...
@interface GGKJThreeViewController ()
@property (weak, nonatomic) IBOutlet UIView *topview;
@property (weak, nonatomic) IBOutlet UITableView *tableview;

@end
static NSString *const cellID = @"PublicService";
@implementation GGKJThreeViewController
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.Headtitle.textColor = [UIColor lightGrayColor];
    cell.texttitle.textColor = [UIColor lightGrayColor];
    [cell.stateBtn setTitle:@"已过期" forState:UIControlStateNormal];
    [cell.stateBtn setBackgroundColor:[UIColor lightGrayColor]];
    return cell;
}
